...
## 1. 도커허브에서 이미지를 가져온다. {#r-docker-pull}
...
## 2. 도커허브에 이미지 넣기 {#r-docker-push-from-hub}
...
## 3. 도커 이미지를 로컬 파일로 저장하고 불러오기 {#r-docker-save-and-load}
...
## 4. 도전과제 {#r-docker-dockerhub-challenge}
